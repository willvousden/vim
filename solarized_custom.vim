...
let s:p.normal.left = [ [ s:blue, s:base02 ], [ s:base01, s:base03 ] ]
let s:p.normal.middle = [ [ s:base02, s:base0 ] ]
let s:p.normal.right = [ [ s:base0, s:base02 ], [ s:base01, s:base03 ] ]
let s:p.normal.error = [ [ s:base3, s:orange ] ]
let s:p.normal.warning = [ [ s:base3, s:yellow ] ]
let s:p.inactive.left =  [ [ s:base03, s:base2 ], [ s:base2, s:base3 ] ]
let s:p.inactive.middle = [ [ s:base03, s:base3 ] ]
let s:p.inactive.right = [ [ s:base03, s:base2 ], [ s:base2, s:base3 ] ]
let s:p.insert.left = [ [ s:green, s:base02 ], [ s:base01, s:base03 ] ]
let s:p.insert.right = copy(s:p.insert.left)
let s:p.replace.left = [ [ s:magenta, s:base02 ], [ s:base01, s:base03 ] ]
let s:p.replace.right = copy(s:p.replace.left)
let s:p.visual.left = [ [ s:violet, s:base02 ], [ s:base01, s:base03 ] ]
let s:p.visual.right = copy(s:p.visual.left)
let s:p.tabline.left = [ [ s:base02, s:base0 ] ]
let s:p.tabline.tabsel = [ [ s:base0, s:base02 ] ]

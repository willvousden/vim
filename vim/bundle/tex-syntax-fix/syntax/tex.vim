...
"
" Modified By: Will Vousden, Apr 13 2011
"
" Notes: {{{1
"
...
if !exists("tex_no_math")
 ...
 if has("conceal") && &enc == 'utf-8' && s:tex_conceal =~ 'd'
  ...
  syn region texMathZoneX	matchgroup=Delimiter start="\$" skip="\\\\\|\\\$"	matchgroup=Delimiter end="\$" end="%stopzone\>"		concealends keepend		contains=@texMathZoneGroup
